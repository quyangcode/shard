...
QueryManager.prototype.queryForSortList = function(sql,params,pageIndex,pageSize,key,desc,callback){
    try {
        checkSort(arguments);
    } catch (e) {
        return callback(e);
    }
    SortQueryManager.queryForSortList(sql,params,this.connections,getStartRow(pageIndex,pageSize),getEndRow(pageIndex,pageSize),key,desc,callback);
}
